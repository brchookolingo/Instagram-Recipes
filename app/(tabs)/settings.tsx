  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50 dark:bg-gray-900" edges={["bottom"]}>
      ...
      <View className="mt-6 px-4">
        <Text className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-2 ml-1">
          App Info
        </Text>
        <View className="bg-white dark:bg-gray-800 rounded-2xl px-4 py-4 gap-2">
          <View className="flex-row justify-between">
            <Text className="text-gray-600 dark:text-gray-300">App Name</Text>
            <Text className="text-gray-800 dark:text-gray-100 font-medium">ReciGrams</Text>
          </View>
          <View className="flex-row justify-between">
            <Text className="text-gray-600 dark:text-gray-300">Version</Text>
            <Text className="text-gray-800 dark:text-gray-100 font-medium">1.0.0</Text>
          </View>
        </View>
      </View>
      ...
      <View className="mt-6 px-4">
        ...
        <View className="bg-white dark:bg-gray-800 rounded-2xl px-4 py-4 gap-2">
          <View className="flex-row justify-between">
            <Text className="text-gray-600 dark:text-gray-300">Recipes saved</Text>
            <Text className="text-gray-800 dark:text-gray-100 font-medium">{recipes.length}</Text>
          </View>
          <View className="flex-row justify-between">
            <Text className="text-gray-600 dark:text-gray-300">Image cache</Text>
      ...
      <View className="mt-6 px-4">
        ...
        <View className="bg-white dark:bg-gray-800 rounded-2xl px-4 divide-y divide-gray-100 dark:divide-gray-700">
          <Pressable
          ...
          >
            ...
            <Text className="text-gray-800 dark:text-gray-100 flex-1">How to Use</Text>
          ...
          >
            ...
            <Text className="text-gray-800 dark:text-gray-100 flex-1">Send Feedback</Text>
            <Ionicons name="chevron-forward" size={16} color="#9ca3af" />
          </Pressable>
        </View>
      </View>
      ...
      <View className="mt-6 px-4 mb-10">
        ...
        <View className="bg-white dark:bg-gray-800 rounded-2xl px-4 py-4 gap-3">
          <Pressable
          ...
          >
            <Text className="text-red-600 dark:text-red-400 font-semibold">Clear All Data</Text>
          </Pressable>
        </View>
      </View>
      </ScrollView>
